...
const ConnectionImpl = require('oracledb/lib/impl/connection.js');
const ThinResultSetImpl = require('oracledb/lib/thin/resultSet.js');
const ThinLobImpl  = require("oracledb/lib/thin/lob.js");
const Protocol = require("oracledb/lib/thin/protocol/protocol.js");
const { BaseBuffer } = require('oracledb/lib/impl/datahandlers/buffer.js');
const {NetworkSession: nsi} = require("oracledb/lib/thin/sqlnet/networkSession.js");
const { Statement } = require("oracledb/lib/thin/statement");
const thinUtil = require('oracledb/lib/thin/util');
const sqlNetConstants = require('oracledb/lib/thin/sqlnet/constants.js');
const constants = require('oracledb/lib/thin/protocol/constants.js');
const process = require('process');
const types = require('oracledb/lib/types.js');
const errors = require("oracledb/lib/errors.js");
const messages = require('oracledb/lib/thin/protocol/messages');
const StatementCache = require('oracledb/lib/thin/statementCache.js');
