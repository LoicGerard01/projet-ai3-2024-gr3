...
const Capabilities = require("oracledb/lib/thin/protocol/capabilities.js");
const {WritePacket, ReadPacket} = require("oracledb/lib/thin/protocol/packet.js");
const errors = require("oracledb/lib/errors");
const utils = require("oracledb/lib/thin/protocol/utils.js");
const traceHandler = require('oracledb/lib/traceHandler.js');
